...
export interface paths {
    ...
    "/api/auth/register/cookie": {
        ...
        put?: never;
        /** Register Cookie */
        post: operations["register_cookie_auth_register_cookie_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/auth/login/cookie": {
        ...
        put?: never;
        /** Login Cookie */
        post: operations["login_cookie_auth_login_cookie_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/auth/refresh/cookie": {
        ...
        put?: never;
        /** Refresh Cookie */
        post: operations["refresh_cookie_auth_refresh_cookie_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/auth/logout/cookie": {
        ...
        put?: never;
        /** Logout Cookie */
        post: operations["logout_cookie_auth_logout_cookie_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/auth/passkey/authenticate/complete/cookie": {
        ...
        get?: never;
        put?: never;
        /** Passkey Auth Complete Cookie */
        post: operations["passkey_auth_complete_cookie_auth_passkey_authenticate_complete_cookie_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/projects/{project_id}/tokens": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List Project Tokens */
        get: operations["list_project_tokens_projects__project_id__tokens_get"];
        put?: never;
        /** Create Project Token */
        post: operations["create_project_token_projects__project_id__tokens_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/projects/{project_id}/tokens/{token_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        delete: operations["revoke_project_token_projects__project_id__tokens__token_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/projects/{project_id}/members/{member_id}": {
        ...
        delete: operations["remove_project_member_projects__project_id__members__member_id__delete"];
        options?: never;
        head?: never;
        /** Update Project Member */
        patch: operations["update_project_member_projects__project_id__members__member_id__patch"];
        trace?: never;
    };
...
export interface components {
    schemas: {
        /**
         * AccessTokenResponse
         * @description Used by cookie-based auth endpoints — refresh token is in an HttpOnly cookie, not the body.
         */
        AccessTokenResponse: {
            /** Access Token */
            access_token: string;
         ...
         * @enum {string}
         */
        ProjectRole: "admin" | "reviewer" | "translator";
        /** ProjectMemberCreate */
        ProjectMemberCreate: {
            /** Username */
            username: string;
         ...
         * @description Registration response for cookie-based flow — refresh token is in an HttpOnly cookie.
         */
        RegisterCookieResponse: {
            /** Access Token */
            access_token: string;
...
export interface operations {
    ...
    register_cookie_auth_register_cookie_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["RegisterCookieResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    login_cookie_auth_login_cookie_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    refresh_cookie_auth_refresh_cookie_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
            cookie?: {
                lz_refresh?: string | null;
            };
        };
        requestBody?: never;
        responses: {
    ...
    logout_cookie_auth_logout_cookie_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    passkey_auth_complete_cookie_auth_passkey_authenticate_complete_cookie_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_project_tokens_projects__project_id__tokens_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ProjectTokenResponse"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    create_project_token_projects__project_id__tokens_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ProjectTokenCreateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["ProjectTokenCreatedResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    revoke_project_token_projects__project_id__tokens__token_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_project_member_projects__project_id__members__member_id__patch: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    remove_project_member_projects__project_id__members__member_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
